...
SYSTEM_PROBE_TAGS = AGENT_TAGS.union({"clusterchecks", "linux", "npm"}).difference("python")
...
LINUX_ONLY_TAGS = {"netcgo", "systemd", "jetson", "linux", "podman"}

# List of tags to always remove when building on Windows
WINDOWS_EXCLUDE_TAGS = {"linux"}
