...
// return the updated Params.  One of `LogForOneShot` or `LogForDaemon`
// must be called.
type Params struct {
...
// config values for the xxxFn fields in Params.  comp/core/log uses
...
func (params Params) LogToFile(logFile string) Params {
