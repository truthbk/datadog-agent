...
func InitConfig(config Config) {
	...
	config.BindEnvAndSetDefault("runtime_security_config.activity_dump.bind.rate", 10)
	config.BindEnvAndSetDefault("runtime_security_config.activity_dump.bind.burst", 20)
	config.BindEnvAndSetDefault("runtime_security_config.activity_dump.dns.rate", 10)
	config.BindEnvAndSetDefault("runtime_security_config.activity_dump.dns.burst", 20)
	config.BindEnvAndSetDefault("runtime_security_config.activity_dump.exec.rate", 100)
	config.BindEnvAndSetDefault("runtime_security_config.activity_dump.exec.burst", 200)
	config.BindEnvAndSetDefault("runtime_security_config.activity_dump.open.rate", 50)
	config.BindEnvAndSetDefault("runtime_security_config.activity_dump.open.burst", 100)
