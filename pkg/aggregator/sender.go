...
// CountHidden should be used to count a number of events that occurred during the check run.
// This metric is hidden in the backend.
func (s *checkSender) CountHidden(metric string, value float64, hostname string, tags []string) {
