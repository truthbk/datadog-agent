...
func (*mockGauge) WithValues(...string) telemetryComponent.SimpleGauge       { return nil }
func (*mockGauge) WithTags(map[string]string) telemetryComponent.SimpleGauge { return nil }
