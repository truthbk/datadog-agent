...
// requestMatcher is reponsible for matching a `network.ConnectionStats` to a `*model.HTTPAggregation`
type requestMatcher func(*httpEncoder, network.ConnectionStats) (*model.HTTPAggregations, uint64, map[string]struct{})
