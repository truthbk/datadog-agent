...
int BPF_KPROBE(kprobe__ip6_make_skb, struct sock *sk) {
...
int BPF_KPROBE(kprobe__udp_sendpage, struct sock *skp) {
    u64 pid_tgid = bpf_get_current_pid_tgid();
...
int BPF_KRETPROBE(kretprobe__udp_sendpage, int sent) {
    u64 pid_tgid = bpf_get_current_pid_tgid();
