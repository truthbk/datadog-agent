...
SEC("fexit/tcp_recvmsg/pre_5_19_0")
int BPF_PROG(tcp_recvmsg_exit_pre_pre_5_19_0, struct sock *sk, struct msghdr *msg, size_t len, int nonblock, int flags, int *addr_len, int copied) {
    if (copied < 0) { // error
        return 0;
    }
...
SEC("fexit/udp_recvmsg/pre_5_19_0")
...
SEC("fexit/udpv6_recvmsg/pre_5_19_0")
