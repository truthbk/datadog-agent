...
func run(log log.Component, config config.Component, senderManager diagnosesendermanager.Component, cliParams *cliParams) error {
	...
	if e != nil {
		...
		filePath, e = flare.CreateDCAArchive(true, path.GetDistPath(), logFile, senderManager)
		if e != nil {
