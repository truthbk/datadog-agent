...
func (p *Provider) generateContainerSpecMetrics(sender sender.Sender, pod *kubelet.Pod, container *kubelet.ContainerSpec, _ *kubelet.ContainerStatus, containerID string) {
