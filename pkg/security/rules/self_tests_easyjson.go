...
func easyjsonF0077844DecodeGithubComDataDogDatadogAgentPkgSecurityModuleRules(in *jlexer.Lexer, out *SelfTestEvent) {
...
func easyjsonF0077844EncodeGithubComDataDogDatadogAgentPkgSecurityModuleRules(out *jwriter.Writer, in SelfTestEvent) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v SelfTestEvent) MarshalEasyJSON(w *jwriter.Writer) {
	easyjsonF0077844EncodeGithubComDataDogDatadogAgentPkgSecurityModuleRules(w, v)
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *SelfTestEvent) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonF0077844DecodeGithubComDataDogDatadogAgentPkgSecurityModuleRules(l, v)
}
