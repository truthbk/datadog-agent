...
__attribute__((always_inline)) u32 get_root_nr_from_task_struct(struct task_struct *task) {
    u64 task_struct_pid_struct_offset;
    LOAD_CONSTANT("task_struct_pid_struct_offset", task_struct_pid_struct_offset);

    struct pid *pid = NULL;
    bpf_probe_read(&pid, sizeof(pid), (void *)task + task_struct_pid_struct_offset);
