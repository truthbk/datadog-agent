...
func TestActivityTree_SharedTestSuite_CreateProcessNode(t *testing.T) {
	if _, err := os.ReadDir(sharedTestSuiteDir); err != nil {
		t.Skip("skip test where testdata dir is unreachable")
	}
