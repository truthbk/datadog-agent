...
func (f *BTFHubConstantFetcher) AppendSizeofRequest(id, typeName string, headers ...string) {
	f.appendRequest(id)
}

// AppendOffsetofRequest appends an offset request
func (f *BTFHubConstantFetcher) AppendOffsetofRequest(id, typeName, fieldName string, headers ...string) {
	f.appendRequest(id)
}
