...
func (p *Probe[T]) AddEventHandler(eventType model.EventType, handler EventHandler) error {
	return nil
}
...
func (p *Probe[T]) AddFullAccessEventHandler(handler EventHandler) error {
	return nil
}
