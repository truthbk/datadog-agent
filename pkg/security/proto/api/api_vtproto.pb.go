...
func (m *RuleSetReportMessage) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.RuleEventDetails) > 0 {
		for iNdEx := len(m.RuleEventDetails) - 1; iNdEx >= 0; iNdEx-- {
			size, err := m.RuleEventDetails[iNdEx].MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *RuleEventDetails) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *RuleEventDetails) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *RuleEventDetails) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *RuleSetReportMessage) SizeVT() (n int) {
	...
	_ = l
	if len(m.RuleEventDetails) > 0 {
		for _, e := range m.RuleEventDetails {
			l = e.SizeVT()
			n += 1 + l + sov(uint64(l))
		}
	}
...
func (m *RuleEventDetails) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RuleSetReportMessage) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RuleEventDetails", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RuleEventDetails = append(m.RuleEventDetails, &RuleEventDetails{})
			if err := m.RuleEventDetails[len(m.RuleEventDetails)-1].UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *RuleEventDetails) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RuleEventDetails: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RuleEventDetails: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
