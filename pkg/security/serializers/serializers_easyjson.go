		...
		case "flags":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Flags = append(out.Flags, v31)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "matched_rules":
			if in.IsNull() {
				...
				if out.MatchedRules == nil {
					if !in.IsDelim(']') {
						out.MatchedRules = make([]*MatchedRuleSerializer, 0, 8)
					} else {
				...
				for !in.IsDelim(']') {
					var v37 *MatchedRuleSerializer
					if in.IsNull() {
						in.Skip()
						v37 = nil
					} else {
						if v37 == nil {
							v37 = new(MatchedRuleSerializer)
						}
						(*v37).UnmarshalEasyJSON(in)
					}
					out.MatchedRules = append(out.MatchedRules, v37)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonA970e379EncodeGithubComDataDogDatadogAgentPkgSecuritySerializers28(out *jwriter.Writer, in EventContextSerializer) {
	...
	}
	{
		...
		if in.MatchedRules == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			out.RawString("null")
		} else {
			out.RawByte('[')
			for v38, v39 := range in.MatchedRules {
				if v38 > 0 {
					out.RawByte(',')
				}
				if v39 == nil {
		...
		case "cap_effective":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.CapEffective = append(out.CapEffective, v40)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "cap_permitted":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.CapPermitted = append(out.CapPermitted, v41)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonA970e379EncodeGithubComDataDogDatadogAgentPkgSecuritySerializers32(out *jwriter.Writer, in CredentialsSerializer) {
	...
	}
	{
		...
		if in.CapEffective == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v42, v43 := range in.CapEffective {
				if v42 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.CapPermitted == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v44, v45 := range in.CapPermitted {
				if v44 > 0 {
					out.RawByte(',')
				}
		...
		case "helpers":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Helpers = append(out.Helpers, v52)
					in.WantComma()
				}
				in.Delim(']')
			}
