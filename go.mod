...
require (
	...
	github.com/DataDog/datadog-agent/pkg/remoteconfig/state v0.40.1
	github.com/DataDog/datadog-agent/pkg/security/secl v0.40.1
	github.com/DataDog/datadog-agent/pkg/trace v0.40.1
	github.com/DataDog/datadog-agent/pkg/util/cgroups v0.40.1
