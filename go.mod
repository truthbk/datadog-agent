...
require (
	...
	github.com/DataDog/datadog-agent/pkg/obfuscate v0.45.0-rc.6
	github.com/DataDog/datadog-agent/pkg/remoteconfig/state v0.45.0-rc.6
	github.com/DataDog/datadog-agent/pkg/security/secl v0.45.0-rc.6
	github.com/DataDog/datadog-agent/pkg/trace v0.45.0-rc.6
	github.com/DataDog/datadog-agent/pkg/util/cgroups v0.45.0-rc.6
	github.com/DataDog/datadog-agent/pkg/util/log v0.45.0-rc.6
	github.com/DataDog/datadog-agent/pkg/util/pointer v0.45.0-rc.6
	github.com/DataDog/datadog-agent/pkg/util/scrubber v0.45.0-rc.6
...
replace (
	github.com/aquasecurity/trivy => github.com/DataDog/trivy v0.0.0-20230526091421-9855cb1cfe99
