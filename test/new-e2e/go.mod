...
require (
	github.com/DataDog/datadog-agent/test/fakeintake v0.0.0-20230807132440-74405bd7445c
	...
	github.com/DataDog/test-infra-definitions v0.0.0-20230728091556-54fc37760174
